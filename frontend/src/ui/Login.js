...
import { registerUser, setProfileImage, verifyUser } from '../store/userSlice';
...
function Login() {
  ...
  return (
    ...
    <Grid>
      ...
      <TextFieldElement name={'password'} label={'password'} placeholder={'password'} type='password' required validation={{required: 'Please enter username'}} fullWidth/>
